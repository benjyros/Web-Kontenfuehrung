    ...
    <section className="bg-base-100">
      ...
      <div className="p-6 space-y-4 md:space-y-6 sm:p-8 flex justify-center">
        <div className="w-1/2 text-left">
          <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white pb-5">
            Kontoübertrag
          </h1>
          <form className="space-y-4 md:space-y-6" onSubmit={preTransfer}>
            <div>
              ...
              <select
                ...
                name="debitAcc"
                id="debitAcc"
                className="select w-full max-w-xs bg-neutral"
                required={true}
              >
                <option disabled selected>
                  Wähle ein Belastungskonto aus
                </option>
            ...
            <div>
              ...
              >
                <option disabled selected>
                  Wähle ein Gutschriftskonto aus
                </option>
