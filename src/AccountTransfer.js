            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6" onSubmit={preTransfer}>
                    ...
                    <div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Betrag eingeben</span>
                            </label>
                        ...
                        <input type="password" name="password" id="password" onChange={(e) => setAmount(e.target.value)} placeholder="Betrag" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="true" />
                        <p>CHF</p>
                    </div>
                    ...
                    <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                        <Link to='/login' className="font-medium text-emerald-600 hover:underline dark:text-emerald-500">Abbrechen</Link>
                    </p>
                </form>
            </div>
        </section>
